...
class RemoteDebugger extends EventEmitter {
   ...
   *   - webInspectorMaxFrameLength - The frame size of Web Inspector
   */
  constructor (opts = {}) {
    super();
    ...
    // When the value is 'undefined', the web inspector max frame length will be the default value
    this.webInspectorMaxFrameLength = _.isNumber(webInspectorMaxFrameLength) ? webInspectorMaxFrameLength : undefined;
