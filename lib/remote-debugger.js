...
class RemoteDebugger extends EventEmitter {
  ...
  constructor (opts = {}) {
    ...
    // When the value is 'null', the web inspector max frame length will be the default value
    this.webInspectorMaxFrameLength = _.isNumber(webInspectorMaxFrameLength) ? webInspectorMaxFrameLength : null;
