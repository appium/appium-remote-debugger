...
goog.html.SafeUrl.unwrap = function (safeUrl) {
  ...
  if (safeUrl instanceof goog.html.SafeUrl && safeUrl.constructor === goog.html.SafeUrl) {
    ...
    goog.asserts.fail("expected object of type SafeUrl, got '" + safeUrl + "' of type " + goog.utils.typeOf(safeUrl));
...
goog.html.SafeUrl.fromMediaSource = function (mediaSource) {
  ...
  const url =
    mediaSource instanceof MediaSource ? goog.fs.url.createObjectUrl(mediaSource) : goog.html.SafeUrl.INNOCUOUS_STRING;
  return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(url);
};
 ...
 */
goog.html.SafeUrl.INNOCUOUS_URL = goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(
  goog.html.SafeUrl.INNOCUOUS_STRING,
);
