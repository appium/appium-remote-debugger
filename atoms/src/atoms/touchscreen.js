 ...
 * @extends {bot.Device}
 */
bot.Touchscreen = class extends bot.Device {
  constructor() {
    super();

    // Not @private: read by the fireSingle*Pointer_ helper functions below, which take a
    // Touchscreen instance as a parameter rather than being methods of the class.
   ...
   *   currentElement.
   */
  move(element, coords, opt_coords2) {
   ...
   * @private
   */
  firePointerEvents_(fireSinglePointer) {
...
/** @private */
bot.Touchscreen.fireSinglePressPointer_;
...
/** @private */
bot.Touchscreen.fireSingleReleasePointer_;
...
/** @private */
bot.Touchscreen.fireSingleMovePointer_;
