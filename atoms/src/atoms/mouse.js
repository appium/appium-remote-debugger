 ...
 * @extends {bot.Device}
 */
bot.Mouse = class extends bot.Device {
  /**
   ...
   *     used to fire events.
   */
  constructor(opt_state, opt_modifiersState, opt_eventEmitter) {
   ...
   * @param {?number=} opt_count Number of clicks that have been performed.
   */
  releaseButton(opt_force, opt_count) {
    if (this.buttonPressed_ === null) {
   ...
   * @private
   */
  fireMouseEvent_(type, opt_related, opt_wheelDelta, opt_force, opt_count) {
    this.hasEverInteracted_ = true;
    if (bot.userAgent.IE_DOC_10) {
      var msPointerEvent =
        /** @type {!Object<string, *>} */ (bot.Mouse.MOUSE_EVENT_MAP_)[/** @type {string} */ (/** @type {?} */ (type))];
      if (msPointerEvent) {
  ...
  getButtonValue_(eventType) {
    ...
    var buttonValue =
      /** @type {!Object<string, *>} */ (bot.Mouse.MOUSE_BUTTON_VALUE_MAP_)[
...
/** @private {number} */
bot.Mouse.NO_BUTTON_VALUE_INDEX_;
...
bot.Mouse.MOUSE_BUTTON_VALUE_MAP_ = (function () {
  ...
  if (bot.userAgent.IE_DOC_PRE9) {
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.CLICK))
    ] = [0, 0, 0, null];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.CONTEXTMENU))
    ] = [null, null, 0, null];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEUP))
    ] = [1, 4, 2, null];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEOUT))
    ] = [0, 0, 0, 0];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEMOVE))
    ] = [1, 4, 2, 0];
  ...
  if (bot.userAgent.IE_DOC_10) {
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTERDOWN))
    ] =
      /** @type {!Object<string, *>} */ (buttonValueMap)[
        /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEUP))
      ];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTERUP))
    ] =
      /** @type {!Object<string, *>} */ (buttonValueMap)[
        /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEUP))
      ];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTERMOVE))
    ] = [-1, -1, -1, -1];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTEROUT))
    ] =
      /** @type {!Object<string, *>} */ (buttonValueMap)[
        /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTERMOVE))
      ];
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTEROVER))
    ] =
      /** @type {!Object<string, *>} */ (buttonValueMap)[
        /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MSPOINTERMOVE))
      ];
  ...
  /** @type {!Object<string, *>} */ (buttonValueMap)[
    /** @type {string} */ (/** @type {?} */ (bot.events.EventType.DBLCLICK))
  ] =
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.CLICK))
    ];
  /** @type {!Object<string, *>} */ (buttonValueMap)[
    /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEDOWN))
  ] =
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEUP))
    ];
  /** @type {!Object<string, *>} */ (buttonValueMap)[
    /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEOVER))
  ] =
    /** @type {!Object<string, *>} */ (buttonValueMap)[
      /** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEOUT))
    ];
...
bot.Mouse.MOUSE_BUTTON_VALUE_MAP_;
...
bot.Mouse.MOUSE_EVENT_MAP_ = (function () {
  var map = {};
  /** @type {!Object<string, *>} */ (map)[/** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEDOWN))] =
    bot.events.EventType.MSPOINTERDOWN;
  /** @type {!Object<string, *>} */ (map)[/** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEMOVE))] =
    bot.events.EventType.MSPOINTERMOVE;
  /** @type {!Object<string, *>} */ (map)[/** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEOUT))] =
    bot.events.EventType.MSPOINTEROUT;
  /** @type {!Object<string, *>} */ (map)[/** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEOVER))] =
    bot.events.EventType.MSPOINTEROVER;
  /** @type {!Object<string, *>} */ (map)[/** @type {string} */ (/** @type {?} */ (bot.events.EventType.MOUSEUP))] =
